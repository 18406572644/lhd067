...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, createEvent, fetchWithEvent, isEvent, eventHandler, setHeaders, createError, sendRedirect, proxyRequest, getRequestHeader, setResponseStatus, setResponseHeader, send, getRequestHeaders, getRequestURL, getResponseHeader, setResponseHeaders, removeResponseHeader, appendResponseHeader, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getResponseStatus, getRouterParam, readBody, getQuery as getQuery$1, getResponseStatusText } from 'file://D:/lhd067/node_modules/h3/dist/index.mjs';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file://D:/lhd067/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import devalue from 'file://D:/lhd067/node_modules/@nuxt/devalue/dist/devalue.mjs';
import destr from 'file://D:/lhd067/node_modules/destr/dist/index.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash, decodePath, withLeadingSlash, withoutTrailingSlash, joinRelativeURL } from 'file://D:/lhd067/node_modules/ufo/dist/index.mjs';
import { hash as hash$1 } from 'file://D:/lhd067/node_modules/nuxt/node_modules/ohash/dist/index.mjs';
import { renderSSRHead } from 'file://D:/lhd067/node_modules/@unhead/ssr/dist/index.mjs';
import { klona } from 'file://D:/lhd067/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file://D:/lhd067/node_modules/defu/dist/defu.mjs';
import { snakeCase } from 'file://D:/lhd067/node_modules/scule/dist/index.mjs';
import { createHooks } from 'file://D:/lhd067/node_modules/hookable/dist/index.mjs';
import { createFetch, Headers as Headers$1 } from 'file://D:/lhd067/node_modules/ofetch/dist/node.mjs';
import { fetchNodeRequestHandler, callNodeRequestHandler } from 'file://D:/lhd067/node_modules/node-mock-http/dist/index.mjs';
import { createStorage, prefixStorage } from 'file://D:/lhd067/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file://D:/lhd067/node_modules/unstorage/drivers/fs.mjs';
import { digest } from 'file://D:/lhd067/node_modules/ohash/dist/index.mjs';
import { toRouteMatcher, createRouter } from 'file://D:/lhd067/node_modules/radix3/dist/index.mjs';
import { readFile } from 'node:fs/promises';
import consola, { consola as consola$1 } from 'file://D:/lhd067/node_modules/consola/dist/index.mjs';
import { ErrorParser } from 'file://D:/lhd067/node_modules/youch-core/build/index.js';
import { Youch } from 'file://D:/lhd067/node_modules/youch/build/index.js';
import { SourceMapConsumer } from 'file://D:/lhd067/node_modules/nitropack/node_modules/source-map/source-map.js';
import { AsyncLocalStorage } from 'node:async_hooks';
import { stringify } from 'file://D:/lhd067/node_modules/devalue/index.js';
import { getContext } from 'file://D:/lhd067/node_modules/unctx/dist/index.mjs';
import { promises } from 'node:fs';
import { fileURLToPath } from 'node:url';
import { dirname as dirname$1, resolve as resolve$1 } from 'file://D:/lhd067/node_modules/pathe/dist/index.mjs';
import { createServerHead as createServerHead$1 } from 'file://D:/lhd067/node_modules/unhead/dist/index.mjs';
import { unref, version } from 'file://D:/lhd067/node_modules/vue/index.mjs';
import { defineHeadPlugin } from 'file://D:/lhd067/node_modules/@unhead/shared/dist/index.mjs';

const serverAssets = [{"baseName":"server","dir":"D:/lhd067/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"D:/lhd067"}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"D:/lhd067/server"}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"D:/lhd067/.nuxt"}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"D:/lhd067/.nuxt/cache"}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"D:/lhd067/.data/kv"}));
...
const _Z3oG9jzZoIOHEP5wYxHHrz824v8_GzlOpCMPe6yDqJM = (nitroApp) => {
...
const assets = {
  "/index.mjs": {
    ...
    "etag": "\"11ae0-9rIzTDPf8BauoWhIcgPNdDPfL/E\"",
    "mtime": "2026-06-20T04:06:23.370Z",
    "size": 72416,
    "path": "index.mjs"
  },
  "/index.mjs.map": {
    "type": "application/json",
    "etag": "\"44a16-NMJU39HZ3dg8M/CpdtPvFynx6aM\"",
    "mtime": "2026-06-20T04:06:23.360Z",
    "size": 281110,
    "path": "index.mjs.map"
  }
};
...
const _luG_gn = eventHandler((event) => {
...
const _lazy_GywBKJ = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '', handler: _luG_gn, lazy: false, middleware: true, method: undefined },
  { route: '/__nuxt_error', handler: _lazy_GywBKJ, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_GywBKJ, lazy: true, middleware: false, method: undefined }
];
...
const getClientManifest = () => import('file://D:/lhd067/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
